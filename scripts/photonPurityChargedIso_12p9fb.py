...
Data_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/tree_GJetLoose_CleanVars/tree_SinglePhoton_2016D.root")
...
lumiText.AddText("12.9 fb^{-1} (13 TeV)")
...
if endcap : 
    can.SaveAs("purityFit_12p9fb_endcap_{0}.png".format(saveTag))
    can.SaveAs("purityFit_12p9fb_endcap_{0}.eps".format(saveTag))
    can.SaveAs("purityFit_12p9fb_endcap_{0}.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_endcap_{0}.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_endcap_{0}.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_endcap_{0}.pdf".format(saveTag))
else : 
    can.SaveAs("purityFit_12p9fb_barrel_{0}.png".format(saveTag))
    can.SaveAs("purityFit_12p9fb_barrel_{0}.eps".format(saveTag))
    can.SaveAs("purityFit_12p9fb_barrel_{0}.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_barrel_{0}.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_barrel_{0}.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_barrel_{0}.pdf".format(saveTag))

fitPad.SetLogy()
fitPadALT.SetLogy()

if endcap : 
    can.SaveAs("purityFit_12p9fb_endcap_{0}_LogY.png".format(saveTag))
    can.SaveAs("purityFit_12p9fb_endcap_{0}_LogY.eps".format(saveTag))
    can.SaveAs("purityFit_12p9fb_endcap_{0}_LogY.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_endcap_{0}_LogY.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_endcap_{0}_LogY.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_endcap_{0}_LogY.pdf".format(saveTag))

else : 
    can.SaveAs("purityFit_12p9fb_barrel_{0}_LogY.png".format(saveTag))
    can.SaveAs("purityFit_12p9fb_barrel_{0}_LogY.eps".format(saveTag))
    can.SaveAs("purityFit_12p9fb_barrel_{0}_LogY.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_barrel_{0}_LogY.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_barrel_{0}_LogY.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_12p9fb_barrel_{0}_LogY.pdf".format(saveTag))
