...
Gjets_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_GJets_HT-600toInf.root") 
Gjets_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_GJets_HT-400to600.root") 
Gjets_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_GJets_HT-200to400.root") 

QCD_tree = TChain("tree")
QCD_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_QCD_HT-1000to1500.root")
QCD_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_QCD_HT-1500to2000.root")
QCD_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_QCD_HT-2000toInf.root")
QCD_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_QCD_HT-300to500.root")
QCD_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_QCD_HT-200to300.root")
QCD_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_QCD_HT-500to700.root")
QCD_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_QCD_HT-700to1000.root")

Data_tree = TChain("tree")
Data_tree.Add("root://cmsxrootd.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV8/tree_GJetLoose_CleanVars/tree_SinglePhoton_2016B.root")
...
if endcap : 
    Gjets_tree.Draw("photon_pfChargedIsoRhoCorr[0]>>promptMC({0})".format(binning),"Photons[0].Pt()>200&&photon_isEB[0]==0&&photon_sigmaIetaIeta[0]<1.&&photon_sigmaIetaIeta[0]<0.0272&&photon_nonPrompt[0]==0{0}".format(cut))
    QCD_tree.Draw("photon_pfChargedIsoRhoCorr[0]>>nonPromptMC({0})".format(binning),"Photons[0].Pt()>200&&photon_isEB[0]==0&&photon_sigmaIetaIeta[0]<1.&&photon_sigmaIetaIeta[0]<0.0272&&photon_nonPrompt[0]==1{0}".format(cut))
    ...
    Gjets_tree.Draw("photon_pfChargedIsoRhoCorr[0]>>promptMC({0})".format(binning),"Photons[0].Pt()>200&&photon_isEB[0]==1&&photon_sigmaIetaIeta[0]<1.&&photon_sigmaIetaIeta[0]<0.0107&&photon_nonPrompt[0]==0{0}".format(cut))
    QCD_tree.Draw("photon_pfChargedIsoRhoCorr[0]>>nonPromptMC({0})".format(binning),"Photons[0].Pt()>200&&photon_isEB[0]==1&&photon_sigmaIetaIeta[0]<1.&&photon_sigmaIetaIeta[0]<0.0107&&photon_nonPrompt[0]==1{0}".format(cut))
...
lumiText.AddText("4.0 fb^{-1} (13 TeV)")
...
if endcap : 
    can.SaveAs("purityFit_4fb_endcap_{0}.png".format(saveTag))
    can.SaveAs("purityFit_4fb_endcap_{0}.eps".format(saveTag))
    can.SaveAs("purityFit_4fb_endcap_{0}.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_endcap_{0}.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_endcap_{0}.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_endcap_{0}.pdf".format(saveTag))
else : 
    can.SaveAs("purityFit_4fb_barrel_{0}.png".format(saveTag))
    can.SaveAs("purityFit_4fb_barrel_{0}.eps".format(saveTag))
    can.SaveAs("purityFit_4fb_barrel_{0}.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_barrel_{0}.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_barrel_{0}.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_barrel_{0}.pdf".format(saveTag))

fitPad.SetLogy()
fitPadALT.SetLogy()

if endcap : 
    can.SaveAs("purityFit_4fb_endcap_{0}_LogY.png".format(saveTag))
    can.SaveAs("purityFit_4fb_endcap_{0}_LogY.eps".format(saveTag))
    can.SaveAs("purityFit_4fb_endcap_{0}_LogY.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_endcap_{0}_LogY.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_endcap_{0}_LogY.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_endcap_{0}_LogY.pdf".format(saveTag))

else : 
    can.SaveAs("purityFit_4fb_barrel_{0}_LogY.png".format(saveTag))
    can.SaveAs("purityFit_4fb_barrel_{0}_LogY.eps".format(saveTag))
    can.SaveAs("purityFit_4fb_barrel_{0}_LogY.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_barrel_{0}_LogY.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_barrel_{0}_LogY.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_4fb_barrel_{0}_LogY.pdf".format(saveTag))
