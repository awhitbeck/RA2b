...
lumiText.AddText("2.6 fb^{-1} (13 TeV)")
...
if endcap : 
    can.SaveAs("purityFit_2p6fb_endcap_{0}.png".format(saveTag))
    can.SaveAs("purityFit_2p6fb_endcap_{0}.eps".format(saveTag))
    can.SaveAs("purityFit_2p6fb_endcap_{0}.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_endcap_{0}.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_endcap_{0}.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_endcap_{0}.pdf".format(saveTag))
else : 
    can.SaveAs("purityFit_2p6fb_barrel_{0}.png".format(saveTag))
    can.SaveAs("purityFit_2p6fb_barrel_{0}.eps".format(saveTag))
    can.SaveAs("purityFit_2p6fb_barrel_{0}.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_barrel_{0}.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_barrel_{0}.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_barrel_{0}.pdf".format(saveTag))

fitPad.SetLogy()
fitPadALT.SetLogy()

if endcap : 
    can.SaveAs("purityFit_2p6fb_endcap_{0}_LogY.png".format(saveTag))
    can.SaveAs("purityFit_2p6fb_endcap_{0}_LogY.eps".format(saveTag))
    can.SaveAs("purityFit_2p6fb_endcap_{0}_LogY.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_endcap_{0}_LogY.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_endcap_{0}_LogY.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_endcap_{0}_LogY.pdf".format(saveTag))

else : 
    can.SaveAs("purityFit_2p6fb_barrel_{0}_LogY.png".format(saveTag))
    can.SaveAs("purityFit_2p6fb_barrel_{0}_LogY.eps".format(saveTag))
    can.SaveAs("purityFit_2p6fb_barrel_{0}_LogY.pdf".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_barrel_{0}_LogY.png".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_barrel_{0}_LogY.eps".format(saveTag))
    canALT.SaveAs("purityFit_ALT_2p6fb_barrel_{0}_LogY.pdf".format(saveTag))
